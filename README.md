...
pnpm test           # 运行 vitest 单元测试（core + cli + desktop，125 条）
...
- 待办：P5 多 agent 编排（编排详设将外置至 specs/orchestration.md）；P6 产品化（进程级沙箱、resume/fork/replay、electron-builder mac/linux 目标等）。
